...
class qaoa(OperatorPool):
    def generate_SQ_Operators(self):
        ...
        # A = QubitOperator('Z0', -1j*0.3) + QubitOperator('Z1 Z3', -1j*0.37) + QubitOperator('Z0 Z1', 1j*0.18) + QubitOperator('Z0 Z3', -1j*0.83) + QubitOperator('Z2', +1j*0.63) + QubitOperator('Z2 Z3', -1j*0.06) + QubitOperator('Z0 Z1 Z2', 1j*0.14) 
        # A = QubitOperator('Z1', -1j*0.73) + QubitOperator('Z2', -1j*0.11) +QubitOperator('Z0', 1j*0.68) +QubitOperator('Z3', 1j*0.28) + QubitOperator('Z1 Z3', -1j*0.93) + QubitOperator('Z0 Z2', -1j*0.78) + QubitOperator('Z0 Z2 Z3', -1j*0.18) + QubitOperator('Z0 Z1 Z3', 1j*0.47) 
        # A = QubitOperator('I0 I1 I2 I3', -1j*2) + QubitOperator('(I0+Z0) (I3+Z3)', -1j*0.25) + QubitOperator('(I1+Z1) (I2-Z2)', -1j*0.25) 
        # self.cost_ops.append(A)
